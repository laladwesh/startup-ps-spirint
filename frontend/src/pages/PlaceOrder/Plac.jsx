...
const PlaceOrder = () => {
  ...
  const proceedToOrder = async () => {
    ...
    let response = await axios.post(url + "/api/order/place", { cartItems: cartItems, user: user })
  ...
  return (
    <div onSubmit={proceedToOrder} className='place-order'>
      ...
      <div className="place-order-right">
        <div className="cart-total">
          ...
          {/* <button onClick={order}>BUY ITEMS</button> */}
          <button onClick={proceedToOrder}>PROCEED TO PAYMENT</button>
        </div>
      </div>
    </div>
  )
